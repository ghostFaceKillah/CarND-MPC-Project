...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        for (int t = 0; t < N - 1; ++t) {
            cost += 5 * CppAD::pow(vars[delta_start + t], 2);
        ...
        for (int t = 1; t < N; ++t) {
            ...
            // actions at time t
            AD<double> delta0 = vars[delta_start + t - delay];
            AD<double> a0 = vars[a_start + t - delay];
